...
class Numeros(QPlainTextEdit):
    ...
    def actualizarAreaNumeroLinea(self, rect, dy):
        ...
        if dy:
            ...
            self.AreaNumeroLinea.update(0, rect.y(), self.AreaNumeroLinea.width(), rect.height())
    ...
    def resizeEvent(self, event):
        ...
        self.AreaNumeroLinea.setGeometry(QRect(cr.left(), cr.top(), self.lineNumberAreaWidth(), cr.height()))
    ...
    def lineNumberAreaPaintEvent(self, event):
        ...
        arriba = self.blockBoundingGeometry(bloque).translated(self.contentOffset()).top()
        ...
        while bloque.isValid() and (arriba <= event.rect().bottom()):
            ...
            if bloque.isVisible() and (abajo >= event.rect().top()):
                ...
                painter.drawText(0, arriba, self.AreaNumeroLinea.width(), alto, Qt.AlignRight, num)
